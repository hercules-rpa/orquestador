...
INSERT INTO amqp_settings (id,"user",password,host,port,subscriptions,exchange_name,queue_name)
    VALUES (1,'guest','guest','localhost',5672,'{"rpa.orchestrator","rpa.orchestrator.*"}','rpa','orchestrator');

INSERT INTO dbprocess_settings (id, "user",password,host,port,database)
    VALUES (1,'postgres','docker','localhost',5432,'process');
...
INSERT INTO orchestrator_settings (id,id_orch,name,company,pathlog_store, cdn_url)
    VALUES (1,'ORCH-REMOTE-1','ORCH-REMOTE-PLEIADES','UMU','/var/log/orchestrator/', 'localhost');
...
INSERT INTO global_settings (id,edma_host_sparql,edma_host_servicios, edma_port_sparql, sgi_ip, sgi_port, database_ip, database_port, sgi_user, sgi_password, ftp_user, ftp_password, ftp_port) 
    VALUES (1,'http://82.223.242.49','https://serviciosedma.gnoss.com', 8890, 'https://salastest.um.es', 80, '10.208.99.12', 5432, 'gestor-rpa', 'gestor-rpa-2021','robot', 'r0B0t_f1P', 2121);
