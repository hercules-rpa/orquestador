...
INSERT INTO public.PROCESS (id, class, name, requirements, description, visible, setting) VALUES
    ...
    (10,'ProcessExtractRegulatoryBases', 'Proceso de extracción de bases reguladoras', 'module_cognitive_treelogic','Proceso que extrae las bases reguladoras del BOE seleccionando un rango de fechas y envía los resultados por correo electrónico.', true, false),
    (13,'ProcessGenerateTransferReport', 'Proceso de generación de informe de transferencia', 'module_cognitive_treelogic','Proceso que genera un informe para el boletín de transferencia.', true, false),
    ...
    (15,'ProcessExtractInfoPDF', 'Process Tabla a Excel', 'module_cognitive_treelogic RPA numpy pandas','Proceso para filtrar tablas y generar un excel a partir de un documento pdf.', false, false),
    (16,'ProcessExtractAward', 'Proceso extracción de concesiones', 'module_cognitive_treelogic RPA numpy pandas','Proceso para ver las solicitudes que han concedido.', true, true),
